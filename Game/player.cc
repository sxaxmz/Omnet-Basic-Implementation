...
Define_Module(Player);    //macro that registers a class with OMNeT++. Do not forget this!


void Player::handleMessage(cMessage *msgin)
{
...
int Player::calculateMove(int num_sticks)  //calculate the number of sticks to take, based on the number of sticks on the table
